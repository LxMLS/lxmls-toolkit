...
python lxmls/big_data/kmers.py ./data/wikipedia/en_perline001.txt > output.en.txt
python lxmls/big_data/kmers.py ./data/wikipedia/pt_perline01.txt > output.pt.txt
python lxmls/big_data/postprocess.py
